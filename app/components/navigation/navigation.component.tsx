    ...
    return(
        <div className="flex lg:flex-row flex-col lg:justify-between lg:px-[163px] px-[20px] lg:mt-0">
            ...
            <div className="flex lg:flex-row flex-col lg:gap-x-6 gap-y-2 place-items-center mt-[10px] lg:mt-0">
                <Link href="/" className="hover:underline hover:text-black text-gray-700">Home</Link>
                <Link href="/work-experience" className="hover:underline hover:text-black text-gray-700">Work Experience & Projects</Link>
